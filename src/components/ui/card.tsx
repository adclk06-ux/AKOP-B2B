...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "akop-card min-w-0 overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("min-w-0 font-semibold leading-none tracking-tight", className)}
    {...props}
  />
))
